...
Book.find({
  ...
  if (err) throw err;
  else console.log('Books fewer than 500 but more than 200 pages: ', bookResults)
})
...
// }, (err, bookResults) => {
//   if (err) throw err;
//   else console.log('Books less than 5(rating) sorted by author: ', bookResults)
// }).sort('author')
...
// }, (err, peopleResults) => {
//   if (err) throw err;
//   else console.log('tall AND rich people ', peopleResults)
// })
...
// }, (err, peopleResults) => {
//   if (err) throw err;
//   else console.log('tall OR rich people ', peopleResults)
// })
...
// }, (err, peopleResults) => {
//   if (err) throw err;
//   else console.log('skinny & grey features(ALIENS): ', peopleResults)
// }).and({
//   weight: {
//     $lt: 70
//   }
...
//   if (err) throw err;
//   else {
//     console.log('kids who have grey hair or whose sibling does: ')
...
//   if (err) throw err;
//   else {
//     console.log('Obese family ')
//     peopleResults.forEach(person => {
//       console.log('FAMILY - Parent info: ', person)
//     })
//   }
// })